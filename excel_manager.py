...
PLAN_MAP: dict[str, str | None] = {
    ...
    "フレッツ 光ネクスト マンション・ハイスピードタイプ（光配線方式）": "ネクストMS",
...
# パートナーコード → 三次店名 変換テーブル
# 同一コードに複数名がある場合は後勝ち（ブロードエンタープライズ優先）
CODE_TO_MITSUGITEN: dict[str, str] = {
    "1016496404": "Yottavias　大口専用",
    "1016496405": "Yottavias　大口専用",
    "1016496406": "Yottavias　大口専用",
    "1016496407": "Yottavias　大口専用",
    "1016496408": "BtoBtoX　通常",
    "1016496409": "BtoBtoX　通常",
    "1016496410": "BtoBtoX　通常",
    "1016496411": "BtoBtoX　通常",
    "1016496412": "BtoBtoX　大口",
    "1016496413": "BtoBtoX　大口",
    "1016496414": "BtoBtoX　大口",
    "1016496415": "BtoBtoX　大口",
    "1016496428": "訪問設置支援ありコード",
    "1016496429": "訪問設置支援無しコード",
    "1016496430": "アールイーピーコア",
    "1016496431": "アールイーピーコア",
    "1016496432": "アールイーピーコア",
    "1016496433": "アールイーピーコア",
    "1016496442": "オフィスソリューション",
    "1016496443": "オフィスソリューション",
    "1016496444": "オフィスソリューション",
    "1016496445": "オフィスソリューション",
    "1016497542": "ラストワンマイル(カスタマーソリューション)",
    "1016497543": "ラストワンマイル(カスタマーソリューション)",
    "1016497544": "ラストワンマイル(カスタマーソリューション)",
    "1016497547": "ネットナビ",
    "1016497548": "ネットナビ",
    "1016497568": "イメージワークス（その他）",
    "1016497569": "イメージワークス（その他）",
    "1016497570": "イメージワークス（その他）",
    "1016497571": "イメージワークス（その他）",
    "1016497572": "イメージワークス(オフィスコム)",
    "1016497573": "イメージワークス(オフィスコム)",
    "1016497574": "イメージワークス(オフィスコム)",
    "1016497575": "イメージワークス(オフィスコム)",
    "1016497607": "フォーカスタマーズ",
    "1016497608": "フォーカスタマーズ",
    "1016497609": "フォーカスタマーズ",
    "1016497610": "フォーカスタマーズ",
    "1016497627": "マックスサポート",
    "1016497628": "マックスサポート",
    "1016497629": "マックスサポート",
    "1016497630": "マックスサポート",
    "1016497631": "バリューパートナーズ",
    "1016497632": "バリューパートナーズ",
    "1016497633": "バリューパートナーズ",
    "1016497634": "バリューパートナーズ",
    "1016497635": "ブロードエンタープライズ",
    "1016497636": "ブロードエンタープライズ",
    "1016497637": "ブロードエンタープライズ",
    "1016497638": "ブロードエンタープライズ",
    "1016497639": "アットウィル",
    "1016497640": "アットウィル",
    "1016497641": "アットウィル",
    "1016497642": "アットウィル",
...
def _convert_code(raw: str, hikari_converted: str = "") -> str:
    ...
    if raw in CODE_TO_MITSUGITEN:
        # コードテーブルに存在するコードはダミービジ or ビジ
        if hikari_converted in ("オフィスA", "オフィス"):
            return "ビジ"
        return CODE_SPECIAL_VAL
...
def _apply_business_rules(data: dict) -> dict:
    ...
    # ── ② ライブカメラルール（クロスと独立して評価）──
    if "ライブカメラ" in mitsugiten:
        data["mitsugiten_converted"] = "ライブカメラ"
        if data.get("plan_converted") == "ネクストF":
            data["toritsugite_converted"] = "クロス"
            data["plan_converted"]        = "クロス"
        else:
    ...
    # ── ③ コードテーブルによる三次店名上書き ──
    # CODE_TO_MITSUGITENに存在するコードは三次店名を固定
    elif code_raw in CODE_TO_MITSUGITEN:
        data["mitsugiten_converted"] = CODE_TO_MITSUGITEN[code_raw]
