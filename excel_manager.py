...
PLAN_MAP: dict[str, str | None] = {
    ...
    "フレッツ光ネクスト隼マンション":                            "隼MS",
    "フレッツ 光ネクスト ファミリー・ハイスピードタイプ":        None,
...
class ExcelManager:
    ...
    def write_record(self, row: int, data: dict):
        ...
        code_conv        = _convert_code(data.get("code", ""))
        ...
        work = _apply_livecamera_rule(work)
